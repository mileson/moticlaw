...
export async function generateMetadata({
  ...
  return buildSeoResourceMetadata("founderAiEmployeeComparison", locale);
}

export default async function AiEmployeeVsHiringAssistantPage({
  searchParams,
}: {
  searchParams: SeoSearchParams;
}) {
  const locale = await resolveSeoLocale(searchParams);
  return <SeoResourcePage kind="founderAiEmployeeComparison" locale={locale} />;
}

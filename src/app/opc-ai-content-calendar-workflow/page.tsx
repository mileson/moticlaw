...
export async function generateMetadata({
  ...
  return buildSeoResourceMetadata("opcAiContentCalendarWorkflow", locale);
}

export default async function OpcAiContentCalendarWorkflowPage({
  searchParams,
}: {
  searchParams: SeoSearchParams;
}) {
  const locale = await resolveSeoLocale(searchParams);
  return <SeoResourcePage kind="opcAiContentCalendarWorkflow" locale={locale} />;
}

...
export async function generateMetadata({
  ...
  return buildSeoResourceMetadata("agentManagementWorkbenchChecklist", locale);
}

export default async function AgentManagementWorkbenchChecklistPage({
  searchParams,
}: {
  searchParams: SeoSearchParams;
}) {
  const locale = await resolveSeoLocale(searchParams);
  return <SeoResourcePage kind="agentManagementWorkbenchChecklist" locale={locale} />;
}
